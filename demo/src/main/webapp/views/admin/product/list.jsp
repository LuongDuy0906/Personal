        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <a href="<c:url value='/admin-product?type=edit'/>" class="btn btn-primary" data-toggle="tooltip" title="Thêm sản phẩm">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-circle" viewBox="0 0 16 16">
                                        <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16"/>
                                        <path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4"/>
                                    </svg>
                            </a>
                            <button id="btnDelete" data-toggle="tooltip" title="Xóa sản phẩm" type="button" href="#" class="btn btn-danger">
        ...
        function deleteNew(data){
            $.ajax({
                ...
                success: function(result){
                    window.location.href = "${Producturl}?type=list&page=1&maxPageItem=5&sortName=ID&sortBy=DESC&message=Xoa_Thanh_Cong";
                },
