                                    ...
                                    <div class="card-body">
                                        ...
                                        <form id="formSubmit">
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <input class="form-control" id="tenNCC" name="tenNCC" type="text" value="${model.tenNCC}" />
                                            ...
                                            <div class="form-floating mb-3">
                                                <input class="form-control" id="tenLH" name="tenLH" type="text" value="${model.tenLH}" />
                                                <label for="soLuong">Tên liên hệ</label>
                                            </div>
                                            <div class="row mb-3">
                                                <div class="col-md-6">
                                                    <div class="form-floating mb-3 mb-md-0">
                ...
                <script>
                    ...
                    function addNew(data){
                        $.ajax({
                            ...
                            success: function(result){
                                window.location.href = "${Supplierurl}?type=edit&ID=" + result.id + "&message=Them_Thanh_Cong";
                            },
                    ...
                    function updateNew(data){
                        $.ajax({
                            ...
                            dataType: 'json',
                            success: function(result){
                                window.location.href = "${Supplierurl}?type=edit&ID=" + result.id + "&message=Sua_Thanh_Cong";
                            },
                            error: function(error){
                                window.location.href = "${Supplierurl}?type=list&page=1&maxPageItem=5&sortName=ID&sortBy=DESCmessage=Loi";
                            }
